...
port_number = 10011
# port_number = 10018
socket_timeout = 1                   # 2 Second timeout on socket listening.
...
firstFrame = None
min_area = 500  # Minimum size of the changes needed to qualify as a change.
                # Default is 500
...
list_max_size = 3  # The maximum size of the array of position data.
...
def capture_and_find_motion():
    ...
    for c in cnts:
        ...
        # print("x_posn: " + str(x_posn) + " y_posn: " + str(y_posn))
        ## text = "Occupied"
    people_count = count
    ...
    try:
        print "Center mass: " + str(find_center_mass(boxes))
    except:
